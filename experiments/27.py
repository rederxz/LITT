...
from model.model_crnn import CRNN_FDS
...
parser.add_argument('--work_dir', type=str, default='/root/log/256_cs_8x_c8_cos_CRNN_fds')
...
rec_net = CRNN_FDS(sharing_size=5, uni_direction=args.uni_direction)
