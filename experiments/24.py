...
from model.model_crnn_v2 import CRNN_V2_no_dilation
...
if __name__ == '__main__':
    ...
    parser.add_argument('--work_dir', type=str, default='/root/log/256_cs_8x_c8_cos_CRNN_v2_new_no_dilation', help='work directory')
    ...
    rec_net = CRNN_V2_no_dilation(uni_direction=args.uni_direction)
