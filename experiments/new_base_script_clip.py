...
def step_train(dataloader, model, criterion, optimizer, writer, epoch, scheduler, clip, **kwargs):
    train_loss = 0
    train_batches = 0
    model.train()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_interval', type=int, default=1, help='Epoch intervals to test')
    parser.add_argument('--work_dir', type=str, default='/root/log/new_base_script_clip', help='work directory')
