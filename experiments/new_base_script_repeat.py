...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_interval', type=int, default=10, help='Epoch intervals to test')
    parser.add_argument('--work_dir', type=str, default='/root/log/new_base_script_repeat', help='work directory')
