...
from model.model_crnn import CRNN_DA
...
if __name__ == '__main__':
    ...
    parser.add_argument('--work_dir', type=str, default='/root/log/256_cs_8x_c8_cos_CRNN_da', help='work directory')
    ...
    rec_net = CRNN_DA(uni_direction=args.uni_direction)
