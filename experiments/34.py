...
parser.add_argument('--mask_path', type=str, default='/root/LITT_mask_16x_c2')
...
parser.add_argument('--sampled_lines', type=int, default=2)
...
parser.add_argument('--work_dir', type=str, default='/root/log/256_cs_16x_c2_cos_CRNN')
