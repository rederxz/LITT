...
parser.add_argument('--mask_path', type=str, default='/root/LITT_mask_128_6x_c4')
parser.add_argument('--num_epoch', type=int, default=200)
parser.add_argument('--batch_size', type=int, default=1 * 4)
parser.add_argument('--lr', type=float, default=0.0001 * 4)
parser.add_argument('--acc', type=float, default=6.0)
...
parser.add_argument('--work_dir', type=str, default='/root/log/128_cs_6x_c4_cos_CRNN_mod_data_aug')
