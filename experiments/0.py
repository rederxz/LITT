...
if __name__ == '__main__':
    ...
    parser.add_argument('--sampled_lines', type=int, default=5, help='Number of sampled lines at k-space center')
    ...
    parser.add_argument('--work_dir', type=str, default='/root/log/128x128', help='work directory')
