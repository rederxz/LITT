...
parser.add_argument('--uni_direction', action='store_false')
...
train_dataset = LITT_v3(img_dir=args.data_path,
                        split_dir='sub_ds_split_cv_1/train',
...
test_dataset = LITT_v3(img_dir=args.data_path,
                       split_dir='sub_ds_split_cv_1/test',
                       nt_network=args.nt_network,
...
optimizer = torch.optim.Adam(rec_net.parameters(), lr=args.lr, betas=(0.9, 0.999))
