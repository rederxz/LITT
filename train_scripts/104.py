...
parser.add_argument('--mask_path', type=str, default='/root/LITT_mask_128_6x_c8')
...
parser.add_argument('--work_dir', type=str, default=f'/root/log/{sys.argv[0][:-3]}')
...
train_transform = data_aug(block_size=(128, 32), rotation_xy=False, flip_t=False, cut_edge=(0, 16))
