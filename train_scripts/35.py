...
parser.add_argument('--mask_path', type=str, default='/root/LITT_mask_128_4x_c8')
...
parser.add_argument('--work_dir', type=str, default='/root/log/128_cs_4x_c8_cos_CRNN_mod_data_aug')
