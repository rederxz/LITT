...
if __name__ == '__main__':
    ...
    parser.add_argument('--work_dir', type=str, default='/root/log/256x256_cs_6x_c8_idc_mask_reduction', help='work directory')
    ...
    rec_net = CRNN_IDC(uni_direction=args.uni_direction, multi_hidden_t=args.multi_hidden_t)
