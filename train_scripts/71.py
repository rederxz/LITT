...
from model.model_zy import RRN_two_stage_only_outer_res
...
parser.add_argument('--work_dir', type=str, default='/root/log/71')
...
rec_net = RRN_two_stage_only_outer_res(n_blocks=3)
