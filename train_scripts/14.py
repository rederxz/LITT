...
from model.model_res import resCRNN
...
if __name__ == '__main__':
    ...
    parser.add_argument('--work_dir', type=str, default='/root/log/256_cs_8x_c8_cos_resCRNN', help='work directory')
    ...
    rec_net = resCRNN(uni_direction=args.uni_direction)
