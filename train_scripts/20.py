...
from model.model_crnn_v2 import CRNN_V2_without_inner_res
...
if __name__ == '__main__':
    ...
    parser.add_argument('--work_dir', type=str, default='/root/log/256_cs_8x_c8_cos_CRNN_v2_new_without_inner_res', help='work directory')
    ...
    rec_net = CRNN_V2_without_inner_res(uni_direction=args.uni_direction)
