...
if __name__ == '__main__':
    ...
    parser.add_argument('--work_dir', type=str, default='/root/log/256_cs_8x_c8_cos_CRNN_v2_new_1_3_1', help='work directory')
    ...
    rec_net = CRNN_V2_1_3_1(uni_direction=args.uni_direction)
