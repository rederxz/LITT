...
if __name__ == '__main__':
    ...
    parser.add_argument('--acc', type=float, default=10.0, help='Acceleration factor for k-space sampling')
    parser.add_argument('--sampled_lines', type=int, default=10, help='Number of sampled lines at k-space center')
    ...
    parser.add_argument('--work_dir', type=str, default='/root/log/256x256_kt_blast_10x_c10', help='work directory')
    ...
    train_dataset = get_LITT_dataset_v2(data_root=args.data_path, split='train',
                                        ...
                                        mask_func=utils.kt_blast_cartesian_mask(acc=args.acc, sample_n=args.sampled_lines),
