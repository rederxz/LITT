...
if __name__ == '__main__':
    ...
    parser.add_argument('--acc', type=float, default=5.0, help='Acceleration factor for k-space sampling')
    ...
    parser.add_argument('--work_dir', type=str, default='/root/log/256x256_kt_blast_5x_c10', help='work directory')
