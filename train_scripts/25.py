...
from model.model_crnn_v2 import CRNN_V2_fix
...
if __name__ == '__main__':
    ...
    parser.add_argument('--work_dir', type=str, default='/root/log/256_cs_8x_c8_cos_CRNN_v2_new_fix', help='work directory')
    ...
    rec_net = CRNN_V2_fix(uni_direction=args.uni_direction)
