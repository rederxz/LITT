...
parser.add_argument('--mat_path', type=str, default='/root/autodl-nas/test_data/test_data_22/res_003_single.mat')
parser.add_argument('--mask_mat_path', type=str, default='/root/autodl-nas/test_data/test_data_21/res_001_single.mat')
parser.add_argument('--model_path', type=str, default='/root/log/256_cs_8x_c8_cos_CRNN_baseline_v3/model.pth')
parser.add_argument('--work_dir', type=str, default='/root/autodl-nas/inference_log/test_data_22_21_256_cs_8x_c8_cos_CRNN6_baseline_v3')
...
with h5py.File(args.mask_mat_path, 'r') as mat_file:
