...
parser.add_argument('--mat_path', type=str, default='/root/autodl-nas/test_data/test_data_28/res_406_single.mat')
parser.add_argument('--model_path', type=str, default='/root/log/39/model.pth')
parser.add_argument('--work_dir', type=str, default='/root/autodl-nas/inference_log/23')
