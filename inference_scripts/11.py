...
from model.model_zy import RRN_multi_stage
...
parser.add_argument('--model_path', type=str, default='/root/log/47/model.pth')
parser.add_argument('--work_dir', type=str, default='/root/autodl-nas/inference_log/11')
...
# model & device
rec_net = RRN_multi_stage(n_blocks=1)
if torch.cuda.is_available():
