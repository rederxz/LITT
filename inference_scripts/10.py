...
from model.model_zy import RRN_two_stage_tfa
...
parser.add_argument('--model_path', type=str, default='/root/log/46/model.pth')
parser.add_argument('--work_dir', type=str, default='/root/autodl-nas/inference_log/10')
...
# model & device
rec_net = RRN_two_stage_tfa(n_blocks=3)
if torch.cuda.is_available():
