...
parser.add_argument('--model_path', type=str, default='/root/log/50/model.pth')
parser.add_argument('--work_dir', type=str, default='/root/autodl-nas/inference_log/12')
...
# model & device
rec_net = RRN_multi_stage(n_blocks=3)
if torch.cuda.is_available():
